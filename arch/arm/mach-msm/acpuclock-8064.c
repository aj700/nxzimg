...
static struct acpu_level acpu_freq_tbl_faster[] __initdata = {
    ...
    { 1, {   378000, HFPLL, 2, 0, 0x1A }, L2(6),   750000 },
    { 1, {   432000, HFPLL, 2, 0, 0x20 }, L2(6),   775000 },	
    { 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(6),   800000 },
    { 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(6),   825000 },
    { 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(6),   825000 },
