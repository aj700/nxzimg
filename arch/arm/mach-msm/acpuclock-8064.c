...
static struct l2_level l2_freq_tbl[] __initdata __initdata = {
	...
	[1]  = { {  384000, PLL_8, 0, 2, 0x00 },  950000, 1000000, 1 },
...
static struct acpu_level acpu_freq_tbl_faster[] __initdata = {
    ...
    { 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(1),   750000 },
    { 1, {   432000, HFPLL, 2, 0, 0x20 }, L2(7),   775000 },	
    { 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(7),   800000 },
    { 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(7),   825000 },
    { 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(7),   825000 },
    { 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(7),   850000 },
    { 1, {   702000, HFPLL, 1, 0, 0x1A }, L2(7),   850000 },
    { 0, {   756000, HFPLL, 1, 0, 0x1C }, L2(7),   875000 },
    { 1, {   810000, HFPLL, 1, 0, 0x1E }, L2(7),   875000 },
    { 0, {   864000, HFPLL, 1, 0, 0x20 }, L2(7),   900000 },
    ...
    { 0, {  1188000, HFPLL, 1, 0, 0x2C }, L2(16),  975000 },
    { 1, {  1242000, HFPLL, 1, 0, 0x2E }, L2(16),  975000 },
    { 1, {  1296000, HFPLL, 1, 0, 0x30 }, L2(16), 1000000 },
    { 1, {  1350000, HFPLL, 1, 0, 0x32 }, L2(16), 1005500 },
    { 1, {  1404000, HFPLL, 1, 0, 0x34 }, L2(16), 1012500 },
    { 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(16), 1020000 },
